    ...
    <body>
        ...
        <section id ="pricing" class="description_content">
            <div>
                <ul>
                    <?php
                        if(isset($_REQUEST["action"])&&$_REQUEST["action"]=="AIngredients"){
                            include_once("View/AIngredients.php");
                        }
                        elseif(isset($_REQUEST["action"])&&$_REQUEST["action"]=="AImportInventory"){
                            include_once("View/AImportInventory.php");
                        }
